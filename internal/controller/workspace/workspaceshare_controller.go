...
func (r *WorkspaceShareReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	var share workspacev1alpha1.WorkspaceShare
	...
	setCondition(&share.Status.Conditions, metav1.Condition{
		Type:               workspacev1alpha1.WorkspaceShareConditionProgressing,
	...
	setCondition(&share.Status.Conditions, metav1.Condition{
		Type:               workspacev1alpha1.WorkspaceShareConditionReady,
...
func (r *WorkspaceShareReconciler) cleanupShare(ctx context.Context, share *workspacev1alpha1.WorkspaceShare, orig *workspacev1alpha1.WorkspaceShare) (ctrl.Result, error) {
	log := logf.FromContext(ctx)
...
func (r *WorkspaceShareReconciler) patchShareStatus(ctx context.Context, share *workspacev1alpha1.WorkspaceShare, orig *workspacev1alpha1.WorkspaceShare) error {
	return r.Status().Patch(ctx, share, client.MergeFrom(orig))
}

func (r *WorkspaceShareReconciler) setShareProgressing(share *workspacev1alpha1.WorkspaceShare, reason, msg string) {
	setCondition(&share.Status.Conditions, metav1.Condition{
		Type:               workspacev1alpha1.WorkspaceShareConditionProgressing,
		Status:             metav1.ConditionTrue,
		Reason:             reason,
...
func rebacTuplesForShare(share *workspacev1alpha1.WorkspaceShare, ws *workspacev1alpha1.Workspace) []RebacTuple {
...
func (r *WorkspaceShareReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	return ctrl.NewControllerManagedBy(mgr).
		For(&workspacev1alpha1.WorkspaceShare{}).
