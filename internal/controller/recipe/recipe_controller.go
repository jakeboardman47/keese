...
// +kubebuilder:rbac:groups=recipe.operator.keese.ai,resources=recipes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=recipe.operator.keese.ai,resources=recipes/status,verbs=get;update;patch
