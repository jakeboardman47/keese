...
func (r *RecipeSourceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if rs.Status.Phase == "" {
		rs.Status.Phase = recipev1alpha1.RecipeSourcePhasePending
	}
	...
	default:
		...
		rs.Status.Phase = recipev1alpha1.RecipeSourcePhaseFailed
		setRecipeSourceCondition(&rs.Status.Conditions, metav1.Condition{
			Type:               recipev1alpha1.RecipeSourceConditionReady,
...
func (r *RecipeSourceReconciler) reconcileOCI(ctx context.Context, rs *recipev1alpha1.RecipeSource, orig *recipev1alpha1.RecipeSource) (ctrl.Result, error) {
	log := logf.FromContext(ctx)
	oci := rs.Spec.OCI

	rs.Status.SourceType = recipev1alpha1.RecipeSourceTypeOCI
	rs.Status.Phase = recipev1alpha1.RecipeSourcePhasePending
	setRecipeSourceCondition(&rs.Status.Conditions, metav1.Condition{
		Type:               recipev1alpha1.RecipeSourceConditionProgressing,
	...
	rs.Status.Phase = recipev1alpha1.RecipeSourcePhaseSynced
	rs.Status.ObservedGeneration = rs.Generation
...
func (r *RecipeSourceReconciler) reconcileGit(ctx context.Context, rs *recipev1alpha1.RecipeSource, orig *recipev1alpha1.RecipeSource) (ctrl.Result, error) {
	log := logf.FromContext(ctx)
	git := rs.Spec.Git

	rs.Status.SourceType = recipev1alpha1.RecipeSourceTypeGit
...
func (r *RecipeSourceReconciler) reconcileConfigMap(ctx context.Context, rs *recipev1alpha1.RecipeSource, orig *recipev1alpha1.RecipeSource) (ctrl.Result, error) {
	...
	if ns.Labels[devEnvLabel] != devEnvValue {
		...
		rs.Status.Phase = recipev1alpha1.RecipeSourcePhaseFailed
		rs.Status.SourceType = recipev1alpha1.RecipeSourceTypeConfigMap
		setRecipeSourceCondition(&rs.Status.Conditions, metav1.Condition{
			Type:               recipev1alpha1.RecipeSourceConditionReady,
			Status:             metav1.ConditionFalse,
...
func (r *RecipeSourceReconciler) cleanup(ctx context.Context, rs *recipev1alpha1.RecipeSource, orig *recipev1alpha1.RecipeSource) (ctrl.Result, error) {
	if !controllerutil.ContainsFinalizer(rs, recipeSourceFinalizer) {
...
func (r *RecipeSourceReconciler) patchRecipeSourceStatus(ctx context.Context, rs, orig *recipev1alpha1.RecipeSource) error {
