...
func MergeBindings(bindings []*authzv1alpha1.GuardrailBinding) (*authzv1alpha1.EffectivePolicy, error) {
	if len(bindings) == 0 {
		return &authzv1alpha1.EffectivePolicy{}, nil
	}
	...
	ep := &authzv1alpha1.EffectivePolicy{
		Tools: authzv1alpha1.EffectiveTools{
			Allow: effectiveAllow,
			Deny:  effectiveDeny,
		},
		TokenBudget: authzv1alpha1.EffectiveTokenBudget{
	...
	if effectiveRL != nil {
		ep.Tools.RateLimit = &authzv1alpha1.EffectiveRateLimit{
...
func extractTools(b *authzv1alpha1.GuardrailBinding) (allow []string, deny []string, hasAllow bool) {
	if b.Spec.Tools == nil {
...
func extractBudget(b *authzv1alpha1.GuardrailBinding) budgetVals {
...
func extractRateLimit(b *authzv1alpha1.GuardrailBinding) *authzv1alpha1.RateLimit {
	if b.Spec.Tools == nil {
		return nil
	}
...
func minRateLimit(a, b *authzv1alpha1.RateLimit) *authzv1alpha1.RateLimit {
	if a == nil {
		return b
	}
	if b == nil {
	...
	return &authzv1alpha1.RateLimit{
		Requests: req,
		Window:   window,
		Scope:    scope,
	}
...
func scopeRank(s authzv1alpha1.RateLimitScope) int {
	switch s {
	case "sa":
		return 0
	case "workspace":
...
func narrowerScope(a, b authzv1alpha1.RateLimitScope) authzv1alpha1.RateLimitScope {
