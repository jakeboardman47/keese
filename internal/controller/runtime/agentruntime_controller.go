...
func (r *AgentRuntimeReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		...
		ar.Status.Phase = runtimev1alpha1.AgentRuntimePhaseDegraded
		ar.Status.Provider = ""
	...
	// 7. Converge to Ready.
	ar.Status.Phase = runtimev1alpha1.AgentRuntimePhaseReady
	ar.Status.Provider = provider
...
func (r *AgentRuntimeReconciler) reconcileDelete(
	ctx context.Context,
	ar *runtimev1alpha1.AgentRuntime,
	orig *runtimev1alpha1.AgentRuntime,
) (ctrl.Result, error) {
	log := logf.FromContext(ctx)
	...
	exList := &runtimev1alpha1.RuntimeExtensionList{}
...
func detectProvider(ar *runtimev1alpha1.AgentRuntime) (string, error) {
