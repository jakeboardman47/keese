...
func (r *WorkflowReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		...
		wf.Status.Phase = workflowv1alpha1.WorkflowPhaseDegraded
	...
	// 8. Status
	if wf.Status.Phase != workflowv1alpha1.WorkflowPhaseDegraded {
		wf.Status.Phase = workflowv1alpha1.WorkflowPhaseReady
	}
...
func (r *WorkflowReconciler) reconcileDelete(ctx context.Context, wf *workflowv1alpha1.Workflow, orig *workflowv1alpha1.Workflow) (ctrl.Result, error) {
	log := logf.FromContext(ctx)
	...
	if activeCount > 0 {
		...
		wf.Status.Phase = workflowv1alpha1.WorkflowPhaseDeleting
		_ = r.patchStatus(ctx, wf, orig)
...
func (r *WorkflowReconciler) reconcileTrigger(_ context.Context, _ *workflowv1alpha1.Workflow, _ *workflowv1alpha1.WorkflowTrigger) error {
...
func (r *WorkflowReconciler) reconcileOutput(_ context.Context, _ *workflowv1alpha1.Workflow, _ *workflowv1alpha1.WorkflowOutput) error {
...
func (r *WorkflowReconciler) patchStatus(ctx context.Context, wf *workflowv1alpha1.Workflow, orig *workflowv1alpha1.Workflow) error {
	return r.Status().Patch(ctx, wf, client.MergeFrom(orig))
}

// setCondition upserts a condition on wf.Status.Conditions.
func (r *WorkflowReconciler) setCondition(wf *workflowv1alpha1.Workflow, condType string, status metav1.ConditionStatus, reason, msg string) {
...
func (r *WorkflowReconciler) emitEvent(wf *workflowv1alpha1.Workflow, eventtype, reason, messageFmt string, args ...interface{}) {
