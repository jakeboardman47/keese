...
func (p *ClientArgoProjector) ProjectWorkflowTemplate(ctx context.Context, wf *workflowv1alpha1.Workflow) (string, error) {
...
func (p *ClientArgoProjector) DeleteWorkflowTemplate(ctx context.Context, wf *workflowv1alpha1.Workflow) error {
...
func argoTemplateName(wf *workflowv1alpha1.Workflow) string {
...
func buildArgoWorkflowTemplate(wf *workflowv1alpha1.Workflow, name string) *argov1alpha1.WorkflowTemplate {
...
func keeseStepsToArgoTemplates(wf *workflowv1alpha1.Workflow) []argov1alpha1.Template {
...
func parametersToArguments(params []workflowv1alpha1.WorkflowRunParameter) argov1alpha1.Arguments {
	if len(params) == 0 {
