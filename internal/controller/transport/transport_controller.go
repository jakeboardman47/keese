...
const (
	...
	// requeueAfterBackoff is the requeue interval on transient dependency errors.
...
func (r *TransportReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	var tr transportv1alpha1.Transport
	...
	// --- Initialize phase ---
	if tr.Status.Phase == "" {
		tr.Status.Phase = transportv1alpha1.TransportPhasePending
	}
	...
	if tr.Spec.Type == transportv1alpha1.TransportTypeNATS && tr.Spec.NATS != nil {
	...
	// --- Transition to Ready ---
	tr.Status.Phase = transportv1alpha1.TransportPhaseReady
	tr.Status.ObservedGeneration = tr.Generation
	r.setCondition(&tr.Status.Conditions, metav1.Condition{
		Type:               "Ready",
...
func (r *TransportReconciler) validateDependencies(ctx context.Context, tr *transportv1alpha1.Transport, orig *transportv1alpha1.Transport) (bool, ctrl.Result, error) {
	tr.Status.Phase = transportv1alpha1.TransportPhaseProvisioning

	switch tr.Spec.Type {
	case transportv1alpha1.TransportTypeNATS:
		return r.validateNATSDeps(ctx, tr, orig)

	case transportv1alpha1.TransportTypeMCP:
		return r.validateMCPDeps(ctx, tr, orig)

	case transportv1alpha1.TransportTypeA2A:
		return r.validateA2ADeps(ctx, tr, orig)

	case transportv1alpha1.TransportTypeStdio:
...
func (r *TransportReconciler) validateNATSDeps(ctx context.Context, tr *transportv1alpha1.Transport, orig *transportv1alpha1.Transport) (bool, ctrl.Result, error) {
	nats := tr.Spec.NATS
	if nats == nil {
		return true, ctrl.Result{}, nil
	}
...
func (r *TransportReconciler) validateMCPDeps(ctx context.Context, tr *transportv1alpha1.Transport, orig *transportv1alpha1.Transport) (bool, ctrl.Result, error) {
	mcp := tr.Spec.MCP
	if mcp == nil {
		return true, ctrl.Result{}, nil
	}
...
func (r *TransportReconciler) validateA2ADeps(ctx context.Context, tr *transportv1alpha1.Transport, orig *transportv1alpha1.Transport) (bool, ctrl.Result, error) {
	a2a := tr.Spec.A2A
	if a2a == nil {
		return true, ctrl.Result{}, nil
	}
	...
	scope := transportv1alpha1.A2AScopeIntraTenant
	if a2a.Scope != nil {
		scope = *a2a.Scope
	}
	if scope == transportv1alpha1.A2AScopeCrossTenant {
...
func (r *TransportReconciler) reconcileNATSStream(ctx context.Context, tr *transportv1alpha1.Transport, orig *transportv1alpha1.Transport) (ctrl.Result, error) {
	if tr.Annotations[autoCreateStreamAnnotation] != "true" {
...
func (r *TransportReconciler) reconcileFinalizer(ctx context.Context, tr *transportv1alpha1.Transport, orig *transportv1alpha1.Transport) {
	ownsStream := tr.Spec.Type == transportv1alpha1.TransportTypeNATS &&
...
// the finalizer.
func (r *TransportReconciler) cleanup(ctx context.Context, tr *transportv1alpha1.Transport, orig *transportv1alpha1.Transport) (ctrl.Result, error) {
	if !controllerutil.ContainsFinalizer(tr, transportFinalizer) {
		return ctrl.Result{}, nil
	}

	tr.Status.Phase = transportv1alpha1.TransportPhaseTerminating
...
func (r *TransportReconciler) buildRebacTuples(tr *transportv1alpha1.Transport) []RebacTuple {
	tuples := []RebacTuple{
...
func (r *TransportReconciler) setDegradedCondition(tr *transportv1alpha1.Transport, reason, msg string) {
	tr.Status.Phase = transportv1alpha1.TransportPhaseDegraded
	r.setCondition(&tr.Status.Conditions, metav1.Condition{
		Type:               "Ready",
		Status:             metav1.ConditionFalse,
		Reason:             reason,
