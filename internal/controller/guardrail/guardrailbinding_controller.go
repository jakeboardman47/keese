...
const (
	...
	// managedLabel is the predicate label required on all managed GuardrailBindings.
...
func (r *GuardrailBindingReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	var binding guardrailv1alpha1.GuardrailBinding
	...
	if err != nil {
		...
		r.setCondition(&binding, guardrailv1alpha1.ConditionParentReadable, metav1.ConditionFalse, "ParentResolveFailed", err.Error())
		r.setPhase(&binding, guardrailv1alpha1.BindingPhaseDegraded)
	...
	r.setCondition(&binding, guardrailv1alpha1.ConditionParentReadable, metav1.ConditionTrue, "ParentResolved", "all parent bindings readable")
	...
	if mergeErr != nil {
		...
		r.setCondition(&binding, guardrailv1alpha1.ConditionReady, metav1.ConditionFalse, "MergeConflict", mergeErr.Error())
		r.setPhase(&binding, guardrailv1alpha1.BindingPhaseDegraded)
	...
	if err := r.validateCEL(ctx, &binding); err != nil {
		...
		r.setCondition(&binding, guardrailv1alpha1.ConditionReady, metav1.ConditionFalse, "CELCompileError", err.Error())
		r.setPhase(&binding, guardrailv1alpha1.BindingPhaseDegraded)
	...
	r.setPhase(&binding, guardrailv1alpha1.BindingPhaseReady)
	r.setCondition(&binding, guardrailv1alpha1.ConditionReady, metav1.ConditionTrue, "MergeComplete", "effective policy computed and written")
...
func (r *GuardrailBindingReconciler) cleanup(ctx context.Context, binding *guardrailv1alpha1.GuardrailBinding, orig *guardrailv1alpha1.GuardrailBinding) (ctrl.Result, error) {
	log := logf.FromContext(ctx)
...
func (r *GuardrailBindingReconciler) resolveParents(ctx context.Context, binding *guardrailv1alpha1.GuardrailBinding) ([]*guardrailv1alpha1.GuardrailBinding, error) {
	parents := make([]*guardrailv1alpha1.GuardrailBinding, 0, len(binding.Spec.Inherit))
	for _, ref := range binding.Spec.Inherit {
		var parent guardrailv1alpha1.GuardrailBinding
...
func (r *GuardrailBindingReconciler) checkDefaultBinding(ctx context.Context, binding *guardrailv1alpha1.GuardrailBinding) error {
	// Only check for Tenant-scoped and Workspace-scoped bindings; Cluster bindings
	// are (or could be) the default themselves.
	if binding.Spec.Scope.Type == guardrailv1alpha1.BindingScopeCluster {
		return nil
	}
	var def guardrailv1alpha1.GuardrailBinding
...
func (r *GuardrailBindingReconciler) validateCEL(_ context.Context, binding *guardrailv1alpha1.GuardrailBinding) error {
...
func rebacTuplesFor(b *guardrailv1alpha1.GuardrailBinding) []RebacTuple {
	...
	if b.Spec.Scope.Type == guardrailv1alpha1.BindingScopeWorkspace && b.Spec.Scope.WorkspaceRef != nil {
...
func (r *GuardrailBindingReconciler) patchStatus(ctx context.Context, binding *guardrailv1alpha1.GuardrailBinding, orig *guardrailv1alpha1.GuardrailBinding) error {
...
func (r *GuardrailBindingReconciler) setPhase(binding *guardrailv1alpha1.GuardrailBinding, phase guardrailv1alpha1.BindingPhase) {
...
func (r *GuardrailBindingReconciler) setCondition(
	binding *guardrailv1alpha1.GuardrailBinding,
	condType string,
