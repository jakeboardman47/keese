...
// spec.implementation.adkPython.
const ProviderName = "adkPython"

// capabilities is the static CapabilityMatrix declared at registration.
// All flags are false at E0 — real capability claims land with E1.
...
// Runtime is the ADK Python provider. Stubs at E0; reconciler logic in E1.
type Runtime struct {
	image string
}
