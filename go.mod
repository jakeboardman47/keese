module github.com/keese-ai/keese

go 1.25.0

require (
	github.com/argoproj/argo-workflows/v3 v3.6.19
	github.com/envoyproxy/ai-gateway v0.3.0
	...
	github.com/kyverno/kyverno v1.14.5
...
// TODO(dep-conflict): github.com/kedacore/keda/v2 — all versions use replace directives
// pinning k8s.io/api to an incompatible version (v0.31.x for v2.16.x, v0.34.x for v2.19.x);
// keese is on v0.33.x. Awaiting upstream KEDA release aligned with k8s v0.33 without replace
// directives, or a vendored API-only copy. ScaledObject type unavailable until then.
