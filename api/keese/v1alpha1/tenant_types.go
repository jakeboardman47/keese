...
// CallRetryBudget constrains per-call retry behaviour.
...
type TenantSpec struct {
	...
	// DefaultCallRetryBudget constrains per-call retry policy for workspaces in this tenant.
	// +optional
	DefaultCallRetryBudget *CallRetryBudget `json:"defaultCallRetryBudget,omitempty"`
