...
> logic, and no spec promotion may land until all 47 design docs AND all 11 spec
...
- **Group C:** P6 (scaffold) starts after P4 design gate passes (all 47 designs current).
