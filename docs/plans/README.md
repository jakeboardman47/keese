...
> logic, and no spec promotion may land until all 44 design docs AND all 11 spec
...
- **Group C:** P6 (scaffold) starts after P4 design gate passes (all 44 designs current).
