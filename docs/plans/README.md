...
> logic, and no spec promotion may land until all 30 design docs AND all 11 spec
...
- **Group C:** P6 (scaffold) starts after P4 design gate passes (all 30 designs current).
...
Full plan with decisions D1–D23, kind list, and phase details:
