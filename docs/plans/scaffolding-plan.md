...
**Local path:** any; this doc travels with the repo. Originally scaffolded at
`/Users/marshallmccain/src/github.com/mccodeman/keese`.
...
**Goal:** No implementation lands until all 22 designs AND all 9 specs score ≥ 90 AND architect opens gate.
...
### Exit criteria
- All 22 designs + 9 specs score ≥ 90.
- `docs/plans/README.md` frontmatter flips `gate_status: open`.
- Architect-signed commit: `docs(architecture): open design gate — 22 designs + 9 specs ≥ 90/100`.
...
11. Architect walks 22 designs + 9 specs, scores each ≥ 90, commits gate-open → gate flips to `open`.
...
|---|---|---:|---:|---:|---|
| 1 | Scope clarity | 10 | 1.0 | 10 | 9 phases + hard gate + 13 kinds + 22 designs + 9 specs explicit. |
