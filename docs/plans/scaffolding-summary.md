...
| P6 operator scaffold | `5dd8d07` | operator-sdk init + create-api for 13 kinds at v1alpha1 across the 3 `keese.ai` groups — every `*_types.go` + `*_controller.go` is a `TODO(design-gate)` stub (26 markers) — OLM bundle validate green |
