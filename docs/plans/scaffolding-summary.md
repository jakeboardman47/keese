...
- Design gate: **CLOSED** per `docs/plans/README.md`
  ...
  until all 32 designs + 11 specs score ≥ 90/100 on the rubric and
...
design authoring** — walk the 32 design stubs in
...
Once all 32 designs are `current`, the 11 specs under `docs/specs/`
